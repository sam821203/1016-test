...
const articlesData = reactive([
    ...
    {
        id: new Date().getTime(),
        title: '假設你回覆之前的版本後，又想回復到最新提交的版本',
        author: '張杰敏',
        content:
            '我好像為什麼事情很悲唉，我想起生命是一場無盡的旅程，充滿了起伏和挑戰。我们经历了成功和失败，欢笑和眼泪，但正是这些经历塑造了我们的性格和使命',
        datePosted: new Date().toLocaleDateString('en-US'),
        ...
        imageUrl: 'https://lh3.googleusercontent.com/p/AF1QipNlza0i2iQ3CNovEADKnrTnBLfRNozjG_1orV14=s1360-w1360-h1020',
    },
])
</script>
...
<template>
    <main>
        ...
        <div v-for="article in articlesData" :key="article.id" class="card-wrap">
            ...
            >>>>>>> eb7c5b280ec9146b31d6f4d8f8b96ae83faa5431
